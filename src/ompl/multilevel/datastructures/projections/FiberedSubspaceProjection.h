...
namespace ompl
{
    ...
    namespace multilevel
    {
        ...
        class FiberedSubspaceProjection : public FiberedProjection
        {
        public:
            FiberedSubspaceProjection(const base::SpaceInformationPtr& siBundle, const base::SpaceInformationPtr& siBase);
            FiberedSubspaceProjection(base::StateSpacePtr bundleSpace, base::StateSpacePtr baseSpace);

            virtual ~FiberedSubspaceProjection() = default;
